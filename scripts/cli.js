...
const contractABI = require("../artifacts/contracts/Metamasksdk.sol/Metamasksdk.json").abi;

program
    .name("metamasksdk-cli")
    .description("CLI tool for Metamasksdk smart contract")
    .version("1.0.0");
